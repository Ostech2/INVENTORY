...
import { Users, Building2, Package, CheckCircle2, TrendingUp, TrendingDown } from "lucide-react";
  ...
  const fetchWardenPerformance = async () => {
    try {
      ...
      const wardenStats: WardenStats[] = (profiles || []).map((profile) => {
        ...
        const hostelWeight = 30;
        const inventoryWeight = 40;
        ...
        const performanceScore = Math.round(hostelScore + inventoryScore + allocationScore);
